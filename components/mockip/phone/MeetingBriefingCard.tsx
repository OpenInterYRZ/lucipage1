      ...
      >
        ...
        >
          ...
          <span className="leading-[1.6] text-[#555]">
            - Series B closed at $42M — 30-month runway confirmed
          </span>
          <span className="leading-[1.6] text-[#555]">
            - v2.4 smart search demo showed strong results
          </span>
          <span className="leading-[1.6] text-[#555]">
            - Mobile nav reduced to 4 tabs per Design Review
          </span>
        </div>
        ...
        >
          ...
          <span className="leading-[1.6] text-[#555]">
            1. v2.4 release readiness &amp; smart search QA status
          </span>
          <span className="leading-[1.6] text-[#555]">
            2. Enterprise pipeline update — 8 late-stage deals
          </span>
          <span className="leading-[1.6] text-[#555]">
            3. Mobile 4-tab nav implementation timeline
          </span>
        </div>
      </div>
    </div>
