  ...
  memories: [
    {
      ...
      detail: "Valuation confirmed during Q3 planning. Funds allocated for EMEA expansion and engineering hiring.",
    ...
    },
    {
      ...
      detail: "14% engagement uptick after new UI rollout. 30-day cohort retention strongest at 8% above target.",
      source: "Q3 Planning Sync",
      sourceTime: "12:45",
    ...
    },
    {
      ...
      detail: "Alex to push through approval today. Tied to EMEA market expansion initiative.",
      source: "Q3 Planning Sync",
      sourceTime: "28:30",
    ...
    },
    {
      ...
      detail: "DevOps flagged latency concerns. Follow-up scheduled this week before final commit.",
      source: "Q3 Planning Sync",
      sourceTime: "07:45",
    ...
    },
    {
      ...
      detail: "David to complete final legal review by Wednesday. Two regional partners already onboarded.",
      source: "Q3 Planning Sync",
      sourceTime: "01:05",
  ...
  transcript: [
    {
      time: "00:02",
      speaker: "Alex",
      text: "Alright, let's get started. Thanks everyone for joining the Q3 planning sync.",
    },
    {
      time: "00:15",
      speaker: "Sarah",
      text: "Happy to be here. I've got the latest conversion numbers pulled up if we want to start there.",
    },
    {
      time: "00:28",
      speaker: "Alex",
      text: "Perfect. Let's kick off with the EMEA expansion update first, then jump into data.",
    },
    {
      time: "01:05",
      speaker: "David",
      text: "So the EMEA rollout is on track. We've onboarded two regional partners and the vendor contracts are nearly finalized.",
    },
    {
      time: "01:42",
      speaker: "Alex",
      text: "Great. Any blockers on the contract side?",
    },
    {
      time: "01:55",
      speaker: "David",
      text: "Just the final legal review. I should have everything signed off by Wednesday.",
    },
    {
      time: "02:30",
      speaker: "Sarah",
      text: "On the data side — engagement is up 14% since the new UI went live last month. Retention is looking strong too.",
    },
    {
      time: "03:15",
      speaker: "Alex",
      text: "That's a solid lift. Is that across all cohorts or mostly new users?",
    },
    {
      time: "03:28",
      speaker: "Sarah",
      text: "Primarily in the 30-day cohort. Returning users are up about 8%, which is still above our target.",
    },
    {
      time: "04:12",
      speaker: "Alex",
      text: "Good. Let's talk about the partnership integration roadmap — I think we're close to alignment there.",
    },
    {
      time: "05:00",
      speaker: "David",
      text: "Agreed. The external stakeholders signed off on the timeline yesterday. We're good to proceed.",
    },
    {
      time: "06:30",
      speaker: "Sarah",
      text: "One thing to flag — the budget reallocation for regional marketing needs final approval. We're looking at $2.5M.",
    },
    {
      time: "07:15",
      speaker: "Alex",
      text: "I'll push that through today. And the Beta API launch — are we still targeting September?",
    },
    {
      time: "07:45",
      speaker: "David",
      text: "September 12th is the new target. The DevOps team flagged some latency concerns we need to address first.",
    },
    {
      time: "08:30",
      speaker: "Alex",
      text: "Let's schedule a follow-up with DevOps this week. Anything else before we wrap?",
    },
    {
      time: "09:10",
      speaker: "Sarah",
      text: "Just the sprint review briefing — I'll have that finalized by end of day.",
    },
    {
      time: "09:45",
      speaker: "Alex",
      text: "Perfect. Good meeting everyone. Let's reconvene Thursday for the sprint review.",
    },
  ] as TranscriptLine[],
  actions: [
    {
      text: "Finalize vendor contracts for EMEA rollout",
      assignee: "David",
      due: "Wed, Feb 12",
    },
    {
      text: "Push through $2.5M budget reallocation approval",
      assignee: "Alex",
      due: "Today",
    },
    {
      text: "Schedule follow-up meeting with DevOps team on latency",
      assignee: "Alex",
      due: "This week",
    },
    {
      text: "Finalize sprint review briefing document",
      assignee: "Sarah",
      due: "EOD Today",
    },
    {
      text: "Confirm Beta API launch date — September 12th",
      assignee: "David",
      due: "Fri, Feb 14",
    },
    {
      text: "Prepare EMEA conversion data deep-dive for next sync",
      assignee: "Sarah",
      due: "Thu, Feb 13",
    },
  ],
...
export default function MemoriesPanel({ isActive }: { isActive: boolean }) {
  ...
  const allSegments = [VIDEO.summary, ...VIDEO.takeaways, ...VIDEO.nextSteps];
  ...
  const takeawayTexts = displayed.slice(1, 1 + VIDEO.takeaways.length);
  const nextStepTexts = displayed.slice(1 + VIDEO.takeaways.length);
  ...
  return (
    <div className="flex h-full w-full bg-white text-left overflow-hidden">
      ...
      <div className="shrink-0 flex flex-2 flex-col overflow-hidden border-r border-black/5">
        <div className="flex items-center justify-between px-5 py-3 shrink-0">
          ...
          <span className="text-[10px] text-text-2">
            {VIDEO.memories.length} extracted
          </span>
        </div>

        <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-2.5 phone-scroll">
          {VIDEO.memories.map((mem, i) => (
            <div
              key={i}
              className="rounded-lg border border-black/5 overflow-hidden hover:border-black/10 transition-colors"
            >
              {/* 引用的关键帧 */}
      ...
      {/* 右侧 - 视频 + Summary/Transcription/Actions */}
      <div className="flex flex-col flex-3 min-w-0 overflow-y-auto phone-scroll">
        {/* 视频标题 */}
        <div className="px-6 py-4 ">
          <h3 className="text-xl font-semibold text-text-0">
            Q3 Planning Sync — {VIDEO.date}
          </h3>
        </div>
        {/* 视频播放器 */}
        <div className="px-4 pb-2">
          <div className="relative w-full aspect-[16/8] shrink-0 overflow-hidden rounded-xl">
            <img
              src={VIDEO.thumbnail}
              alt={VIDEO.date}
              className="w-full h-full object-cover"
          ...
          {subTab === "actions" && (
            <div className="space-y-3">
              ...
              <p className="text-[12px] text-text-2">
                {VIDEO.actions.length} tasks extracted from this meeting
              </p>
              <ul className="space-y-2">
                {VIDEO.actions.map((action, i) => (
                  <li
                    key={i}
