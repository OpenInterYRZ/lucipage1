...
const tabsData = [
  ...
  },
  {
    id: "act",
    label: "Act",
    title: <>Auto-invoke Agents to complete tasks.</>,
    description: "Auto-invoke Agents to complete tasks.",
...
export default function FeatureTabs() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 font-sans text-text-0">
      {/* Tabs 导航 */}
      <div className="flex border-b border-grey-2 mb-16 relative">
              ...
              <motion.video
                ...
                animate={
                  isActive
                    ...
                    : { opacity: 0, scale: 0.95, filter: "blur(20px)", zIndex: 0 }
                }
                transition={{
                  duration: 0.35,
                  ease: [0.25, 0.46, 0.45, 0.94],
