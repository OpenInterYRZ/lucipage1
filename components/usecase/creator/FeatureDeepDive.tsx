...
const features = [
  {
    title: "Batch-Analyze Competitor Videos",
    desc: "You probably watch 50+ videos a week scouting for ideas. Which one dropped a killer hook at the 3-minute mark? Which had a transition rhythm worth stealing? You used to rely on memory — now just toss them in. AI breaks down structure, scripts, and pacing automatically so you can read the teardown instead of rewatching every clip.",
    bg: "/landscape/lan2.webp",
  },
  {
    title: "Inspiration Strikes? One Line Is Enough",
    desc: 'You\'re watching a video and an idea hits — open Telegram and say "this angle could be a video." That\'s it. AI links your note to whatever you were watching at that moment. Next time you search "topic ideas" while writing a script, the original clip, your exact words, and all the surrounding context come flooding back.',
...
const actionItems = [
  { text: "Reuse the rhetorical-question hook in next short", done: true },
  { text: "Test 3-second cold open before brand intro", done: true },
  { text: 'Adapt the "pain → promise" script arc for our niche', done: false },
  { text: "A/B test jump-cut pacing vs. smooth transitions", done: false },
];
          ...
          <div className="flex flex-col gap-3 px-4 py-3">
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[11px] leading-relaxed text-text-1">
                Opening hook: rhetorical question → pain point → bold promise
                (0:00–0:08). Jump cuts every 2.5s keep retention through
                mid-roll. CTA placed at the 3:12 emotional peak, not at the end.
                Closing loop callbacks to the opening question for completion
                bias.
              </p>
            </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-20 py-16 md:py-28">
        ...
        <div className="flex flex-col gap-4 mb-16">
          <h2 className="text-[28px] md:text-[40px] font-semibold leading-tight text-center text-text-0">
            How LUCI Supercharges Creators
          </h2>
          <p className="text-base text-text-2 max-w-2xl mx-auto text-center leading-relaxed">
            From batch video teardowns to instant material recall, LUCI handles
            the busywork so you can focus on creating.
          </p>
        </div>
