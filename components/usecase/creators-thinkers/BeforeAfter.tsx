...
const beforeItems = [
  "Brilliant ideas forgotten minutes after meetings",
  "Notes scattered across 5 different tools",
  "Hours spent organizing before you can start creating",
  "No way to connect related thoughts across projects",
  "Starting from scratch every time you write something",
];

const afterItems = [
  "Every idea auto-captured and tagged in real-time",
  "All knowledge unified in one searchable graph",
  "Ideas auto-organized — jump straight to creating",
  "Connections between concepts surfaced automatically",
  "Drafts generated from your existing ideas and notes",
];
        ...
        >
          <div className="flex items-center gap-3 rounded-full bg-[#F9FAFB] border border-[#E5E7EB] px-5 py-2">
            <span className="text-[13px] text-[#9CA3AF]">
              Average creative output increase
            </span>
