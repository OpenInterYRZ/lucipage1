      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-20 py-20 md:py-32">
        ...
        >
          ...
          <blockquote className="max-w-[680px] text-[20px] md:text-[24px] font-medium leading-relaxed text-text-0">
            &ldquo;LUCI turned my chaotic notes into a connected knowledge base.
            Ideas I had months ago now resurface exactly when I need them.
            It&apos;s like having perfect memory for creativity.&rdquo;
          </blockquote>
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <div className="flex flex-col items-start">
              ...
              <span className="text-[13px] text-text-2">
                Content Strategist, CreativeFlow
              </span>
            </div>
          </div>
        </motion.div>
