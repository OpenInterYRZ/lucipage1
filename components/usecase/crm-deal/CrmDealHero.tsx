...
export default function CrmDealHero() {
  return (
      ...
      <div className="max-w-[1300px] mx-auto flex flex-col items-center pt-32 pb-20 px-6 md:px-20">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            Watch LUCI automatically enrich a CRM deal with context from
            meetings, emails, and messages — then update the pipeline and
