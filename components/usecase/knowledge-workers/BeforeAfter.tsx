...
const beforeItems = [
  "30 minutes every morning triaging emails and Slack",
  "Searching 4 different tools to find one piece of information",
  "Re-reading meeting notes to remember what was decided",
  "Manually compiling weekly reports from scattered sources",
  "Losing critical context when switching between projects",
];

const afterItems = [
  "Daily digest surfaces what matters before you ask",
  "One search across all meetings, docs, and messages",
  "Every decision tracked with full context and sources",
  "Reports auto-generated from your knowledge base",
  "Cross-project context linked and always available",
];
        ...
        >
          <div className="flex items-center gap-3 rounded-full bg-[#F9FAFB] border border-[#E5E7EB] px-5 py-2">
            <span className="text-[13px] text-[#9CA3AF]">
              Average time saved on information retrieval
            </span>
