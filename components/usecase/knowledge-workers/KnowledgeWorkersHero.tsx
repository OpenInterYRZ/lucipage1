...
export default function KnowledgeWorkersHero() {
  return (
      ...
      <div className="max-w-[1300px] mx-auto flex flex-col items-center pt-32 pb-20 px-6 md:px-20">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            LUCI digests emails, meetings, docs, and chats — then surfaces
            exactly what you need, when you need it. Your personal research
            assistant that never forgets.
          </motion.p>
