...
const beforeItems = [
  "20 minutes after every meeting organizing notes",
  "Tracking action items manually in spreadsheets",
  "30 minutes before every 1:1 digging through chat history",
  "40 minutes every Friday writing the weekly report",
  "Searching 5 different tools to find context on one topic",
];

const afterItems = [
  "Meetings auto-transcribed with key insights extracted",
  "Action items auto-tracked with overdue reminders",
  "LUCI prepares 1:1 context for you automatically",
  "Weekly reports generated from meeting data",
  "Cross-meeting topics linked automatically",
];
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-20 py-20 md:py-32">
        ...
        >
          <div className="flex items-center gap-3 rounded-full bg-[#F9FAFB] border border-[#E5E7EB] px-5 py-2">
            <span className="text-[13px] text-[#9CA3AF]">Average weekly savings</span>
            <ArrowRight className="h-3.5 w-3.5 text-[#9CA3AF]" />
            <span className="text-[13px] font-bold text-[#22C55E]">5+ hours</span>
          </div>
        </motion.div>
      </div>
    </section>
