...
export default function PrivacyFirstHero() {
  return (
      ...
      <div className="max-w-[1300px] mx-auto flex flex-col items-center pt-32 pb-20 px-6 md:px-20">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            LUCI runs on your private VM. No third-party servers, no data
            leaving your infrastructure. Enterprise-grade AI with complete
            data sovereignty.
          </motion.p>
